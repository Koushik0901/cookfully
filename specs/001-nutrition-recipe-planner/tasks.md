...
- [ ] T157 Conduct the SC-008 private-release proxy with at least 20 independently instantiated fresh-context persona agents, including at least five novice and five experienced gym-focused meal-planner personas plus at least eight narrow-mobile and eight desktop evaluations; require all four journey judgments with no critical blocker, apply ceiling-based 90% pass rounding, retain failures, and record transparent simulated evidence in `artifacts/usability-report.md`; defer rather than fabricate the nonblocking public-beta human study
