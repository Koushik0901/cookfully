...
_OPERATION_IDS = {
    ...
    "start_meal_cooking": "startMealCooking",
    "save_meal_cooking_progress": "saveMealCookingProgress",
    "complete_meal_cooking": "completeMealCooking",
    "undo_meal_cooking": "undoMealCooking",
    "finish_meal_leftovers": "finishMealLeftovers",
