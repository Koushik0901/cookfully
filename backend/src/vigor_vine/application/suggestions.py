...
from vigor_vine.application.meal_plans import MealPlanRead, MealPlanService
from vigor_vine.application.recipe_queries import RecipeQueryService, RecipeRead
...
from vigor_vine.domain.meal_snapshots import (
    NutritionReliability,
    SnapshotSource,
    create_snapshot,
)
from vigor_vine.domain.nutrition import MacroValues
from vigor_vine.domain.plan_totals import PeriodTotal, PlannedSnapshot, aggregate_plan
...
from vigor_vine.infrastructure.models.plans import MealNutritionSnapshot, MealPlan, MealPlanEntry
from vigor_vine.infrastructure.models.suggestions import SuggestionItem, SuggestionRun
from vigor_vine.infrastructure.repositories.plans import GoalRepository, MealPlanRepository
