...
export type UserGoal = components["schemas"]["UserGoal"];
export type UserGoalWrite = components["schemas"]["UserGoalWrite"];
export type MealTarget = components["schemas"]["MealTarget"];
