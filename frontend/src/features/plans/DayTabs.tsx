...
export function DayTabs({ dates, selected, onSelect, totals }: { dates: string[]; selected: string; onSelect: (date: string) => void; totals: Record<string, PeriodTotal> }) {
